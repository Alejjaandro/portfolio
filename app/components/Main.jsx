    ...
    return (
        <div id='home' className='w-full h-screen text-center'>
            <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                <div>
                    <h1 className='text-2xl md:text-2xl py-4 text-gray-700'>
                        {"Hi, I'm "}<span className='text-violet-600'>Alejandro</span>
                    </h1>
                    <h1 className='text-2xl md:text-2xl py-2 text-gray-700'>
                        A Full Stack Web Developer
                    </h1>
                    <p className='hidden md:inline-block py-4 text-gray-600 max-w-[70%] m-auto'>
                        {"I'm "} a Junior <strong>Full Stack Developer</strong> passionate about creating dynamic and user-friendly web applications.
                    </p>
                    <p className='text-sm py-2 text-gray-600 max-w-[70%] m-auto'>
                    ...
                    <p className='hidden md:inline-block py-2 text-gray-600 max-w-[70%] m-auto'>
