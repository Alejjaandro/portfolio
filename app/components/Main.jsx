        ...
        <div id='home' className='w-full h-screen text-center pt-24 '>
            <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                <div className='dark:text-white'>
                    <h1 className='text-2xl md:text-2xl lg:text-3xl xl:text-4xl py-4'>
                        {"Hi, I'm "}<span className='text-violet-600 dark:text-violet-400'>Alejandro</span>
                    </h1>
                    <h1 className='text-2xl md:text-2xl lg:text-3xl xl:text-4xl py-2'>
                        A Full Stack Web Developer
                    </h1>
                    <p className='hidden md:inline-block xl:text-lg py-4 max-w-[70%] m-auto'>
                        {"I'm "} a Junior <strong>Full Stack Developer</strong> passionate about creating dynamic and user-friendly web applications.
                    </p>
                    <p className='text-sm md:text-base xl:text-lg py-2 max-w-[70%] m-auto'>
                    ...
                    <p className='hidden md:inline-block xl:text-lg py-2 max-w-[70%] m-auto'>
                    ...
                    <p>
                        <a href="#projects" className="xl:text-lg py-2 text-violet-600 dark:text-violet-400 underline cursor-pointer">
