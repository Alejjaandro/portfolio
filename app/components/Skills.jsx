...
export default function Skills() {
    return (
        <div id='skills' className='w-full px-2 py-24'>
            ...
            <div className='max-w-[1440px] mx-auto flex flex-col justify-center h-full dark:bg-gray-800'>
                <p className='uppercase text-xl tracking-widest text-violet-600 dark:text-violet-400'>Skills</p>
                <h2 className='py-4 dark:text-white'>What I Know</h2>
