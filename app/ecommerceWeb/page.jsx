    ...
    return (
        <div className='w-full'>
            <div className='w-screen h-[50vh] relative'>
                ...
                <Image src={EcommerceWebImg} className='absolute z-1' layout='fill' objectFit='cover' alt='/' />
                <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                    <h2 className='py-2'>Ecommerce Web</h2>
                    <h3>Next JS / CSS3</h3>
                </div>
            </div>
                ...
                <div className='col-span-4'>
                    ...
                    <div className='my-2'>
                        ...
                        <ul className='list-disc list-inside'>
                            ...
                            <li>Product filters and price sort</li>
                        </ul>
                    </div>
                    <p className='mt-4'>
                        This web template is designed for a professional ecommerce that provides electronic products. 
                    ...
                    <a href='https://github.com/Alejjaandro/ecommerce-web' target='_blank' rel='noreferrer'>
                        <button className='px-8 py-2 mt-4 mr-8'>Code</button>
                    </a>
                    <a href='https://alejjaandro-ecommerce-web.vercel.app' target='_blank' rel='noreferrer' >
